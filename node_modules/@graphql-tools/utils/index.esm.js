...
function rebuildAstNode(astNode, fieldOrInputFieldConfigMap) {
    if (astNode == null) {
        return undefined;
    }
    const newAstNode = {
...
function rebuildExtensionAstNodes(extensionASTNodes) {
    if (!(extensionASTNodes === null || extensionASTNodes === void 0 ? void 0 : extensionASTNodes.length)) {
        return [];
    }
